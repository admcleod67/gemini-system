...
4. Admin visibility and control over attached sessions (especially runaway CPU-bound programs until [**Milestone 22**](22-execution-fairness-cpu-bound-yield.md))
...
- CPU-bound opcode-budget yield or operator **BREAK** ([**Milestone 22**](22-execution-fairness-cpu-bound-yield.md))
